...
export const DEFAULT_TITLE =
  "ФК «Уличне» (Карпати) — футбол у селі Улич, Дрогобичський район";

export const DEFAULT_DESCRIPTION =
  "Офіційний сайт ФК «Уличне» (ФК Карпати Уличне): футбол у селі Улич, у Уличному та Дрогобицькому районі. Новини, матчі, склад, турнірна таблиця й календар ігор.";
